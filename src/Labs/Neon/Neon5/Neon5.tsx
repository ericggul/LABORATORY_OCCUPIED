import style from "./Neon5.module.scss";
    ...
    return (
      <div
        ...
        style={{
          ...
          top: y,
          background: `white`,
          transform: `rotate(${getRandom(0, 180)}deg)`,
        }}
      />
    );
  };

  const numbers = Math.floor((size.width * size.height) / 600);
