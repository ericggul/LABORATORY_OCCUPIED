import style from "./RadialGradientTesting.module.scss";
...
class App {
  ...
  resize() {
    ...
    this.particlesNum = 4000;
    this.particles = [];

    this.startPointsNum = 500;
    this.startPoints = [];
  ...
  init() {
    ...
    for (var i = 0; i < this.particlesNum; i++) {
      this.particles.push(
        new Plane(
          getRandom(0, Math.min(this.stageWidth, this.stageHeight) * 0.1),
