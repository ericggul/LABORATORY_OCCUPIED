import style from "./WhiteMonuments5.module.scss";
import { useState, useEffect, useCallback } from "react";

export default function WhiteMonuments5() {
  ...
  const Container = ({ i, loc }: Props) => {
    ...
    const [top, setTop] = useState(loc + 180 * Math.sin((i / 30) * Math.PI));
    const [left, setLeft] = useState(
      ((size.width + 200) / 2) * (i / 270) - 100
    );
    return (
      <div
