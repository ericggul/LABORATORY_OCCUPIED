...
class App {
  ...
  resize() {
    ...
    this.particlesNum = Math.ceil(this.stageHeight / 10);

    for (let i = 0; i < this.particlesNum + 10; i++) {
      this.particles.push(
        new Row(
          (this.stageHeight * i) / this.particlesNum,
          2 * (1 - Math.abs(i - this.particlesNum / 2) / this.particlesNum),
          10 * (1 - Math.abs(i - this.particlesNum / 2) / this.particlesNum),
          this.stageWidth
        )
      );
    }
