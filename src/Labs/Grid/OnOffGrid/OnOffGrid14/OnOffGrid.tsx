...
class Canvas {
  ...
  draw(timestamp: any) {
    ...
    const relativeX = Math.floor(this.mousePos.x / this.textureSize);
...
class Element {
  ...
  constructor(
    ...
    this.j = j;
    this.unitSize = size;
    this.renderSize = this.unitSize * getRandom(0, 2);
    this.opacity = 0;
  ...
  draw(ctx: any, elapsed: any, mousePos: any, relativeX: any) {
    ...
    const location = Math.abs(relativeX - this.i) % this.xInterval;
