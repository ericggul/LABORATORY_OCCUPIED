...
그러나 스크린에 투영되는 이미지는 참여자가 업로드한 사진이 그대로 노출되지 않습니다. 사용자의 사진을 픽셀화되고, 그 픽셀화된 이미지들은 다양한 회전과 왜곡의 과정을 거칩니다. 이는 오래된 매체인 텔레비전은 물론이고, 새로운 스크린인 Web 2.0 기반 플랫폼들 모두에 투영되는 우리의 이미지는 실제의 이미지가 아닌 변환되고 왜곡된 이미지임을 상징합니다.`,
  ...
  {
    title: "참여 방법",
    description: `텔레비전에 내가 나왔으면 정말 좋겠네 정말 좋겠네는 여러분들이 올려주신 사진을 바탕으로 변환한 이미지를 청년미술상점 내 모니터에 송출하는 참여형 예술입니다.
    1. laboratory-occupied.com/television으로 접속, 참여하기 버튼을 클릭합니다.
    2. 텔레비전(청년미술상점 내 모니터)에 송출하고 싶은 사진을 업로드해주세요.
    3. 개인 식별을 위한 휴대번호 뒷 4자리를 입력합니다.
    4. 작품 시스템에 성공적으로 여러분의 사진이 등록되었습니다. 순서가 되면 올려주신 사진의 변환된 이미지가 청년미술상점 내 모니터에 송출됩니다. 앞선 대기자가 있을 경우 송출 시간에 지연이 있을 수 있습니다. 사진은 매 5분마다 송출됩니다.`,
  },
];
