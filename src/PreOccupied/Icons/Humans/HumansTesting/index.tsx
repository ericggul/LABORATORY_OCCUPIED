    ...
    for (let i = 0; i < this.iconNumber; i++) {
      this.iconSets.push(
        new Icon(
          ...
          i,
          this.heightIdx,
          this.stageWidth / (this.iconNumber - 1)
        )
      );
    }
  }
...
class Icon {
  ...
  constructor(
    ...
    this.sexSpeed = 0.0005;
    this.sexAmpl = widthInterval / 2;
  ...
  draw(ctx: any, time: any) {
    const xPos =
      this.pos.x +
      (this.evenPos ? 1 : -1) * Math.sin(time * this.sexSpeed) * this.sexAmpl;
    this.margin =
