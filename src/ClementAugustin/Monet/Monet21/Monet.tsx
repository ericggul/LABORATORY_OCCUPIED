...
class Canvas {
  ...
  animate() {
    ...
    for (
      var i = -this.interval * this.overflow;
      i < this.imgWidth + this.interval * this.overflow;
      i = i + this.interval
    ) {
      for (
        var j = -this.interval * this.overflow;
        j < this.imgHeight + this.interval * this.overflow;
        j = j + this.interval
      ) {
        const angle = 0;
        ...
        this.ctx.drawImage(
          ...
          j,
          this.cropper,
          this.cropper * getRandom(0, getRandom(0, 4)),
          0,
          0,
