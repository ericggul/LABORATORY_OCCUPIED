...
class Canvas {
  ...
  init() {
    ...
    this.draw(10, 20, { min: 0.9, max: 1 }, 1);
    this.draw(10, 10, { min: 0.9, max: 1 }, 1);
    this.draw(320, 320, { min: 0.8, max: 0.9 }, 0.1);
    this.draw(5, 5, { min: 0.2, max: 0.4 }, 1);
    this.draw(7, 7, { min: 0.2, max: 0.4 }, 1);
    this.draw(10, 30, { min: 0.9, max: 1 }, 0.3);
    this.draw(640, 640, { min: 0.1, max: 0.2 }, 1);
  }
