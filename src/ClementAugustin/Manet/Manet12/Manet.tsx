...
class Canvas {
  ...
  init() {
    ...
    this.draw(4, 15, { min: 0.9, max: 1 }, 1);
    this.draw(2, 10, { min: 0.9, max: 1 }, 1);
    this.draw(10, 20, { min: 0.9, max: 1 }, 1);
    this.draw(3, 8, { min: 0.9, max: 1 }, 1);
    this.draw(5, 20, { min: 0.9, max: 1 }, 1);
    this.draw(100, 320, { min: 0.8, max: 0.9 }, 0.1);
  }
