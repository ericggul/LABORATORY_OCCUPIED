...
class Canvas {
  ...
  init() {
    ...
    this.draw(20, 20, { min: 0.9, max: 1 }, 1);
    this.draw(20, 20, { min: 0.9, max: 1 }, 1);
    this.draw(320, 320, { min: 0.8, max: 0.9 }, 0.1);
    this.draw(30, 30, { min: 0.2, max: 0.4 }, 1);
    this.draw(160, 160, { min: 0.1, max: 0.9 }, 0.2);

    this.draw(20, 40, { min: 0.9, max: 1 }, 0.7);
    this.draw(640, 160, { min: 0.1, max: 1 }, 1);
    // this.drawSpecific(
    //   { min: 400, max: 500 },
    //   { min: 450, max: 550 },
    //   20,
