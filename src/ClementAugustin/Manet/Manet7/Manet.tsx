...
class Canvas {
  ...
  init() {
    ...
    this.draw(3, 30, { min: 0.9, max: 1 }, 1);
    this.draw(10, 10, { min: 0, max: 0.2 }, 1);
    this.draw(20, 20, { min: 0, max: 0.2 }, 1);
    this.draw(40, 40, { min: 0, max: 0.2 }, 1);
    this.draw(80, 80, { min: 0, max: 0.2 }, 1);
    this.draw(160, 160, { min: 0, max: 0.2 }, 1);
    this.draw(320, 320, { min: 0, max: 0.2 }, 1);
    this.draw(640, 640, { min: 0.3, max: 0.4 }, 1);
  }
